...
render(){
	...
	return(<form className="orng col-sm-12 col-md-6 col-lg-6 mb-10" onSubmit={this.handleTimeEntry}><div><h4 className="mb-0">Enter Class Time:</h4></div><div><h5 className="mt-0 mb-10"> (Example: MWF 9:00-9:52am)</h5></div><input type="text" name="t" ref="in"></input><div className="mt-10 mb-0 "><p className="mt-0 mb-0 note">*Note: Partial input allowed.</p></div><div className="mt-0 mb-0"><p className="mt-0 mb-0 note">'M' displays all classes that have class on Monday.</p></div><div className="mt-0 mb-10"><p className="mt-0 mb-0 note">'1:00' displays all classes that have class at 1:00.</p></div></form>)
